...
import com.example.demoapplication.Presenter.GetAllSezAddressPresenter;
...
public class SEZ_ADDRESS_ACTIVITY extends AppCompatActivity implements SEZddressAdapter.sezDetails, GetAllSEZAddressContract.View {

    RecyclerView recyclerView;
    SEZddressAdapter seZddressAdapter;
    Boolean shipping,billing = false;
    GetAllSEZAddressDataLoader getAllSEZAddressDataLoader;
    GetAllSezAddressPresenter getAllSezAddressPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllSEZAddressDataLoader = new GetAllSEZAddressDataLoader(this);
        getAllSezAddressPresenter = new GetAllSezAddressPresenter(this,getAllSEZAddressDataLoader);

        String url = "https://api-stage.daalchini.co.in/partner/api/v2/warehouse/1/sez-location";

        getAllSezAddressPresenter.onContinue(url);
...
//        startActivity(i);
    ...
    public void onSuccess(SezAddressGetResponse sezAddressGetResponse) {
        ...
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(mLayoutManager);
        setAdapter(sezAddressGetResponse);
    }
}